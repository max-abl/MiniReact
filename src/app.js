...
var promise = new Promise(function (resolve, reject) {
  ...
  if (contentElement) { // On vérifie qu'on a bien un content dans le DOM pour permettre au MiniReact de fonctionner
    resolve("Content element found !  MiniReact can work ! Yay !");
  }
  else {
    reject(Error("No Content element found ... MiniReact won't work :("));
  }
});
